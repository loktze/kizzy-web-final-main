...
const Page3: React.FC<Page3Props> = ({ currentPage }) => {
  return (
    <div className="relative h-screen bg-[#110c2f] bg-cover bg-center z-20">
      <div className="max-w-[2000px] mx-auto px-4 relative h-full">
        ...
        <div className="hidden lg:flex">
          <div
            className={`absolute left-[10%] top-[17%] lg:top-[15%] 2xl:left-[12%] 2xl:top-[14%] ${currentPage === 2 ? "opacity-100 translate-x-[0]" : "opacity-0 translate-x-[10px]"
          ...
          <div
            className={`absolute left-[6%] bottom-[17%] lg:bottom-[22%] 2xl:left-[8%] 2xl:bottom-[18%] ${currentPage === 2 ? "opacity-100 translate-x-[0]" : "opacity-0 translate-x-[10px]"
              } delay-300 ease-in-out transition-all transform duration-700`}
          >
            <div className="relative">
              <div
          ...
          <div
            className={`right-[6%] top-[38%] xl:right-[6%] xl:top-[37%] 2xl:right-[6%] ${currentPage === 2 ? "opacity-100 translate-x-[0]" : "opacity-0 -translate-x-[10px]"
